...
namespace Kutuphane.DataAccess.Classes
{
    public class EmanetIslemleri
    {
        ...
        DataSet dataSet;
        OleDbCommand cmd;
        public DataSet listele() // dataset döndüren listele fonksiyonu oluşturdum
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
            dataSet = new DataSet();

            // SQL select komutu kullanıldı
        ...
        public Boolean kitapAlma(int ogrenciID, int kitapID, int borc, DateTime teslimTarihi, DateTime emanetTarihi, Boolean teslimDurumu)
        {
            ...
            // kitapIslemleri fonksiyonunu çağırdım
        ...
        public DataSet ara(int ID, String ogrenci_kitap) // emanet arama işlemi yapıldı
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
            dataSet = new DataSet();
