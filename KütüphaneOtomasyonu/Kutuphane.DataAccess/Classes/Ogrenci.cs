...
namespace Kutuphane.DataAccess.Classes
{
    public class Ogrenci
    {
        ...
        public DataSet listele() // dataset döndüren listele fonksiyonu
        {
            ...
            // DataSet ile Veritabanını bağladım
        ...
        public DataSet ara(string ad) // // isme göre öğrenci arama
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
            dataSet = new DataSet();
        ...
        public Boolean guncelle(int id, string ad, string soyad, string ogrenciNo, string tcNo, string telNo) // verileri yeni veriler ile güncelleme yapıldı
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
        ...
        public Boolean guncelle(int id, int borc) // ID'ye göre borç verisini güncelle 
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
        ...
        public Boolean guncelle(int id, Boolean kitapAlabilirMi) // ID'ye göre kitap alabilme durumunu güncelle 
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
        ...
        public Boolean sil(int id) // id'ye göre sonuç alarak silme
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
