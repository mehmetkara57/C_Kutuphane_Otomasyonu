...
namespace Kutuphane.DataAccess.Classes
{
    public class Kitap
    {
        ...
        public DataSet ara(string ad) // isme göre kitap arama
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
            dataSet = new DataSet();
        ...
        public Boolean guncelle(int id, string ad, string yazar, string tur, int sayfa, int stok) // verileri yeni veriler ile güncelledim
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
        ...
        public Boolean sil(int id) //id'ye göre sonuç alarak silme işlemi
        {
            accessConnection = new DBAccessConnection();
            connection = accessConnection.connect();
