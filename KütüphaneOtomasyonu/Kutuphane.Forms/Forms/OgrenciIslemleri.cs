...
namespace Kutuphane.Forms
{
    public partial class OgrenciIslemleri : Form
    {
        ...
        public void tabloGuncelle() // İşlemlerden sonra tabloyu güncellemek için fonksiyon oluşturdum
        {
            tarihiGecmisSayac = 0;
        ...
        private void OgrenciIslemleri_Load(object sender, EventArgs e)
        {
            ...
            this.tbl_emanetTableAdapter.Fill(this.db_kutuphaneDataSet.tbl_emanet);
            tabloGuncelle();
        ...
        private void OgrenciIslemleri_Load_1(object sender, EventArgs e)
        {
            // veritabanına veri yükler
            this.tbl_emanetTableAdapter.Fill(this.db_kutuphaneDataSet.tbl_emanet);
            // veritabanına veri yükler
        ...
        private void btn_iade_Click_1(object sender, EventArgs e)
        {
            if (dataGridViewEmanet.SelectedRows.Count == 1) 
            {
        ...
        {
            if (dataGridViewKitaplar.SelectedRows.Count == 1) 
            {
