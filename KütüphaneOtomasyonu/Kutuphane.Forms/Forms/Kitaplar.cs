...
namespace Kutuphane.Forms
{
    public partial class Kitaplar : Form
    {
        ...
        public Kitaplar(FormWindowState windowState, Point location)
        {
            InitializeComponent();
        ...
        public void tabloGuncelle() // İşlemlerden sonra tabloyu güncelleme fonksiyonu oluşturuldu
        {
            // Kitapları listele ve dataGridView'e aktar
        ...
        {
            // textBoxArama'nın içine bilgi mesajı yazabilmek için event ekledim. 
       ...
       private void textBoxArama_Leave(object sender, EventArgs e)
        ...
        private void btn_ogrenciler_Click_1(object sender, EventArgs e)
        {
        ...
        private void Kitaplar_Load_1(object sender, EventArgs e)
        {
            // TODO: Bu kod satırı 'db_kutuphaneDataSet.tbl_kitap' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.tbl_kitapTableAdapter.Fill(this.db_kutuphaneDataSet.tbl_kitap);
